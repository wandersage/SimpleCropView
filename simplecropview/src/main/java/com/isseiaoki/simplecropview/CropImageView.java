...
public class CropImageView extends ImageView {
    ...
    public interface BitmapPreviewListener {
        void onBitmapPreview(Bitmap bitmap);
    }
    public void setBitmapPreviewListener(BitmapPreviewListener listener){
        bitmapPreviewListener = listener;
    }
    private BitmapPreviewListener bitmapPreviewListener;
    ...
    public void setScreenRatio(int screenX, int screenY){
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mIsInitialized) {
            ...
            if (bitmapPreviewListener !=null)
                bitmapPreviewListener.onBitmapPreview(getCroppedBitmap());
        }
    }
...
//        float ratio = screenY/screenX;
//        float ratio2 = screenX/screenY;
//        float xdelta = (mFrameRect.right - mFrameRect.left) /2 * ratio2;//* ratio2 ;
//        float ydelta = (mFrameRect.bottom - mFrameRect.top) *ratio2;
//        x1 = mFrameRect.left + xdelta ;
//        x2 = mFrameRect.right - xdelta;
//        y1 = mFrameRect.top + ydelta;
//        y2 = mFrameRect.bottom - ydelta;
//        RectF r1, r2;
